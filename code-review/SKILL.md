...
MANDATORY PRE-STEP (UX):
If the change touches any user-facing UI/flow (pages/components/forms/buttons/dialogs/toasts/loading/navigation), you MUST read and apply:
- `.kiro/skills/code-review/ux-guideline.md`
