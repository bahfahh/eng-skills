...
- [Prerequisites Assessment](#1-prerequisites-assessment)
- [System Architecture Modeling](#2-system-architecture-modeling)
- [Load Modeling Framework](#3-load-modeling-framework)
- [Performance Modeling Engine](#4-performance-modeling-engine)
- [Bottleneck Identification System](#5-bottleneck-identification-system)
- [Optimization Strategy Generation](#6-optimization-strategy-generation)
- [Capacity Planning Integration](#7-capacity-planning-integration)
- [Output Generation and Recommendations](#8-output-generation-and-recommendations)
- [Continuous Performance Learning](#9-continuous-performance-learning)
- [Usage Examples](#usage-examples)
- [Quality Indicators](#quality-indicators)
- [Common Pitfalls to Avoid](#common-pitfalls-to-avoid)

Simulate system performance under various loads with capacity planning, bottleneck identification, and optimization strategies. Produce YAML findings using the schema in `output-format.md`.
...
- E-commerce platform under Black Friday traffic (10x normal load)
- REST API for mobile app with 1M+ daily active users and geographic distribution
- Database analytics workload with real-time reporting requirements
- Microservices mesh under failure scenarios and auto-scaling conditions
